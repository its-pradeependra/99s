        ...
        <div className="mx-auto max-w-10xl px-4 sm:px-2 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-3 gap-y-8 md:gap-8  max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div className=" mb-10 lg:mb-0 p-4 flex  items-center flex-col">
              <Link
                to="/"
                className="flex justify-center lg:justify-start w-[12rem]"
              >
                <img
                  src={
                    "https://firebasestorage.googleapis.com/v0/b/fir-india-77ae4.appspot.com/o/WebMaterial%2Ffooterlogo-transparent.png?alt=media&token=15f6b616-db20-4c3b-8ef2-1991e1681b01"
                  }
                  alt="99s INDIA"
            ...
            <div className="lg:mx-auto text-left  p-2">
              ...
              <ul className="text-sm  transition-all duration-500">
                ...
                <li className="mb-2">
                  <a
                    href="https://drive.google.com/file/d/1QsjkSAGsy6s6YqHuVuvN5o545S9ToTXr/view?usp=sharing"
                    className=" text-gray-600 hover:text-gray-900"
                  >
                    Terms & Conditions
                  </a>
                ...
                <li>
                  <a
                    target="_blank"
                    href="https://drive.google.com/file/d/1ZzigYjkzOGHmogUPRUWad_DHVaK2lUQ4/view?usp=sharing"
                    className=" text-gray-600 hover:text-gray-900"
                  >
                    Privacy Policy
                  </a>
            ...
            <div className="lg:mx-auto text-left p-2 ">
              ...
              <p className="text-sm text-gray-500 leading-6 mb-7">
                Empower Women to Soar
              </p>
              <Link
                to="/donate"
                className="flex items-center justify-center gap-2 border border-blue-800 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-blue-800 font-semibold transition-all duration-500 hover:bg-blue-100"
              >
                Donate
                <svg
                  width="15"
          ...
          <div className="py-2 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500 ">
                ©️<a href="https://pagedone.io/"> India Section Ninety-Nines</a>{" "}
                2024. All rights reserved.
              </span>
              <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                <a
                  href="https://x.com/99sIndiaSection?t=q9EJ4RhxzA2q_4c8izPQkg&s=09"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/99s_india_section?igsh=MWZ4d3dqczR1dmtkbA=="
                  target="_blank"
                ...
                <a
                  href="https://facebook.com/groups/2405620646324248/"
                  target="_blank"
